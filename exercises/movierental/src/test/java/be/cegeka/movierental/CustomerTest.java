...
public class CustomerTest {
    ...
    public void addRental() {
        ...
        Movie movie1 = Movie.builder("Gone with the Wind", MoviePriceCode.REGULAR);
    ...
    public void statementForNewReleaseMovie() {
        Customer customer2 = new Customer("Sallie");
        Movie movie1 = Movie.builder("Star Wars", MoviePriceCode.NEW_RELEASE);
        Rental rental1 = new Rental(movie1, 3); // 3 day rental
        customer2.addRental(rental1);
        String expected = "Rental Record for Sallie\n" +
                "\tStar Wars\t9.0\n" +
    ...
    public void statementForChildrensMovie() {
        Customer customer2 = new Customer("Sallie");
        Movie movie1 = Movie.builder("Madagascar", MoviePriceCode.CHILDRENS);
        Rental rental1 = new Rental(movie1, 3); // 3 day rental
        customer2.addRental(rental1);
        String expected = "Rental Record for Sallie\n" +
                "\tMadagascar\t1.5\n" +
    ...
    public void statementForManyMovies() {
        ...
        Movie movie2 = Movie.builder("Star Wars", MoviePriceCode.NEW_RELEASE);
        Rental rental2 = new Rental(movie2, 2); // 2 day rental
        Movie movie3 = Movie.builder("Gone with the Wind", MoviePriceCode.REGULAR);
